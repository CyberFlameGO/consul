...
func TestAgent_JoinWAN_viaMeshGateway(t *testing.T) {
	...
	a2 := StartTestAgent(t, TestAgent{Name: "betty", HCL: `
		domain = "consul"
		advertise_addr_wan = "127.0.99.2" # super fake so that attempts to bypass the mesh gateway will not work
		node_name = "betty"
		datacenter = "dc2"
		primary_datacenter = "dc1"
		# tls
	...
	a3 := StartTestAgent(t, TestAgent{Name: "bonnie", HCL: `
		domain = "consul"
		advertise_addr_wan = "127.0.99.3" # super fake so that attempts to bypass the mesh gateway will not work
		node_name = "bonnie"
		datacenter = "dc3"
		primary_datacenter = "dc1"
		# tls
